...
if (isset($_GET['increase'])) {
    ...
    // Increase quantity by 1 if item exists in cart
...
if (isset($_GET['decrease'])) {
    ...
    // Decrease quantity by 1 if item exists in cart
    if (isset($_SESSION['cart'][$pid])) {
        $_SESSION['cart'][$pid]['quantity'] -= 1;

        // Remove item if the quantity reaches 0
...
if (isset($_POST['place_reservation'])) {
    ...
    if (empty($selected)) {
        ...
        // Calculate total price of only the selected items
        ...
        // this generates a unique reservation code
        ...
        // Save each selected item to the reservation and update the stock
        foreach ($selected as $pid) {
            $pid = (int) $pid;
            ...
            // Save item to reservation_items table
            ...
            // If the stock hits 0, this marks as out of stock
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($item['image_url']): ?>
                                                <img src="../<?php echo htmlspecialchars($item['image_url']); ?>" class="cart-img" alt="">
                                            <?php else: ?>
